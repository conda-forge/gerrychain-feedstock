...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/gerrychain-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=6421&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/gerrychain-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `gerrychain` can be installed with:

```
conda install gerrychain
```

It is possible to list all of the versions of `gerrychain` available on your platform with:
